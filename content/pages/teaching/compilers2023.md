Title: CCOM 4087 - Compiler Design - Spring 2023
date: 2021-12-22
category: Teaching
...
|------|-----------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------|
| Jan  | Introduction to OCaml       | [Learn OCaml in Y minutes](https://learnxinyminutes.com/docs/ocaml/)                                                                                           | [Warmup]({filename}compilers2022/warmup.md)     |
|      | Introduction                | [Lecture 1](https://course.ccs.neu.edu/cs4410sp22/lec_intro_notes.html)                                                                                            | [depython]({filename}compilers2022/depython.md) |
| Feb  | Integers compiler           | [Lecture 2](https://course.ccs.neu.edu/cs4410sp22/lec_neonate_notes.html)                                                                                          |                                                 |
|      | Lexing and Parsing          | [Real World OCaml Parsing](http://dev.realworldocaml.org/parsing-with-ocamllex-and-menhir.html)                                                                | [parser]({filename}compilers2022/parser.md)     |
|      | "variables" and stacks      | [Lecture 3](https://course.ccs.neu.edu/cs4410sp22/lec_let-and-stack_notes.html)                                                                                    | [prettier]({filename}compilers2022/prettier.md) |
|      | Conditional expressions     | [Lecture 4](https://course.ccs.neu.edu/cs4410sp22/lec_anf_notes.html) [otro anf]({filename}compilers2022/otroanf.md)                                               | [ifnz] [anfed]                                  |
| Mar  | Types                       | [Lecture 5](https://course.ccs.neu.edu/cs4410sp22/lec_tagging-values_notes.html)                                                                                   | [Boolop]({filename}compilers2022/Boolop.md)     |
|      | Function calls              | [Lecture 6](https://course.ccs.neu.edu/cs4410sp22/lec_function-calls_notes.html)                                                                                   | [print]                                         |
...
|      | Mutable tuples              | [Lecture 14](https://course.ccs.neu.edu/cs4410sp22/lec_mutable-tuples_notes.html)                                                                                  |                                                 |
|      | Spring break                |                                                                                                                                                                |                                                 |
