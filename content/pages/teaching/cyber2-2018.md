title: CCOM 4995-001 Systems and Network Security
date: 2018-05-10
category: Teaching
...
# CCOM 4089 Systems and Network Security (New number!)
...
## Course schedule
   ...
   Class will meet Monday and Wednesday from 8:30 to 9:50 AM in **room
   to be determined**. In [UPR-RP](http://www.uprrp.edu/) attendance
   is compulsory.
...
|--------|----------------|----------------|--------------|-----|
|   | Intro          | 0x100          | Lec 1 [text](http://css.csail.mit.edu/6.858/2015/lec/l01-intro.txt), [video](https://www.youtube.com/watch?v=M2gc6b1hmk8) 
...
|   | Stack exploit   | 0x480 - 0x482 |  | [Lab 1](http://css.csail.mit.edu/6.858/2015/labs/lab1.html) (part 1, exercise 2)
...
|   | Privilege separation | 0x280 - 0x283 | Lec 4 [text](http://css.csail.mit.edu/6.858/2014/lec/l04-okws.txt), [video](https://www.youtube.com/watch?v=XnBJc3-N2BU)  | [Lab 2](http://css.csail.mit.edu/6.858/2015/labs/lab2.html) (exercise 1, 2, 3)
...
|  | Networking | 0x430 - 0x475 | Lec 12 [text](http://css.csail.mit.edu/6.858/2014/lec/l12-tcpip.txt), [video](https://www.youtube.com/watch?v=3lDUGRqZmXA)
...
|  | Tor | [paper](http://css.csail.mit.edu/6.858/2014/readings/tor-design.pdf) | Lec 19 [video](https://www.youtube.com/watch?v=rIf_VZQr-dw)
